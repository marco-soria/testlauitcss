...
export const Header = () => {
  return (
    <div className="pt-5 flex justify-between font-semibold items-center">
      <div className="ml-8">
      ...
      <div className="hidden lg:inline">
          <ul className="flex space-x-2 text-sm">
            <li
              className="py-1 px-3 hover:bg-slate-200 hover:rounded-full cursor-pointer"
            >
              Vehicles
            </li>
            <li
